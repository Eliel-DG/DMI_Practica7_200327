...
class _HomeState extends State<Home> {
  ...
  final TextStyle customTextStyle = TextStyle(
    fontFamily: 'karla', // Nombre de la fuente definido en pubspec.yaml
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData appTheme = ThemeData.dark().copyWith(
      primaryColor:
          Color.fromARGB(255, 19, 168, 214), // Color azul para la AppBar
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text("MovieApp-200327"), // Título de la aplicación
          actions: <Widget>[
            IconButton(
              icon: Icon(
                Icons.search,
              ...
              new DrawerHeader(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/honkai.png'),
                        fit: BoxFit.cover)),
